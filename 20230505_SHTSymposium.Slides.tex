 ...
 \begin{frame}[label=current]
	...
	\only<2>{%
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center){%	
				\mode<beamer>{%
					\animategraphics[loop,autoplay,width=\linewidth,every=\everyframe]{24}{.images/R108/2010a/mrg/R108C04At-mrg/animation.frames/R108C04At-mrg_crop_rotate_Composite_tif0}{000}{180}%
					}%
				\mode<handout>{%
					\includegraphics[width=\linewidth]{.images/R108/2010a/mrg/R108C04At-mrg/animation.frames/R108C04At-mrg_crop_rotate_Composite_tif0060}%
				}
			};%
		\end{tikzpicture}%
	}%
