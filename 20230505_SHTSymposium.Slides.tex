...
\begin{frame}
	\frametitle{Wieso brauchen wir \uct-Bildgebung?}
	\begin{columns}
		\begin{column}{0.49\linewidth}
			% https://www.cancerimagingarchive.net/nbia-search/?saved-cart=nbia-76761575299081509
			\only<1-4|handout:1-4>{%
		...
		\begin{column}{0.3\linewidth}
			...
			\begin{tikzpicture}[x=\imagescale,y=-\imagescale,spy using outlines={rectangle,magnification=\mag,size=\size,connect spies}]
				\begin{scope}
					...
					\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{./images/Mouse01_Lugol_15pct_20230421_rec_Middle_Axial}};
				\end{scope}
		...
		\begin{column}{0.3\linewidth}
			...
			\begin{tikzpicture}[x=\imagescale,y=-\imagescale,spy using outlines={rectangle,magnification=\mag,size=\size,connect spies}]
				\begin{scope}
					...
					\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{-/images/{Mouse01_Lugol_15pct_20230421_rec_Middle_Coronal}};
				\end{scope}
		...
		\begin{column}{0.3\linewidth}
			...
			\begin{tikzpicture}[x=\imagescale,y=-\imagescale,spy using outlines={rectangle,magnification=\mag,size=\size,connect spies}]
				\begin{scope}
					\clip (0,0) rectangle (1944,1941);
					%\clip (972.0,970.5) circle (970.5);
					\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{./images/{Mouse01_Lugol_15pct_20230421_rec_Middle_Sagittal};
				\end{scope}
				%\spy [red] on (1644,1641) in node at (0,0) [anchor=north west];
				% 1944.000px = 29.16mm -> 100px = 1500.000um -> 33.333px = 500um, 6.667px = 100um
				%\draw[|-|,blue,thick] (0,970) -- (1944,970) node [sloped,midway,above,fill=white,semitransparent,text opacity=1] {\SI{29.16}{\milli\meter} (1944px) TEMPORARY!};
