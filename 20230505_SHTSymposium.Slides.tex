...
\mode<beamer>{\progressbar@pbwd=0.8\linewidth}%
\mode<handout>{\progressbar@pbwd=0.8\linewidth}%
...
\def\progressbar@progressbar{%
	...
	\par%
		...
		\end{tikzpicture}%
	\mode<beamer>{\hfill bit.ly/SHTuCT\xspace|\xspace v.\xspace\href{https://github.com/habi/Talk.2023.SHTSymposium/commit/\gitHash}{\gitAbbrevHash}\xspace|\xspace \insertframenumber/\inserttotalframenumber}%
\mode<handout>{\hfill bit.ly/SHTuCT\xspace|\xspace \today\xspace|\xspace \insertframenumber/\inserttotalframenumber}%
	\hspace*{4ex}%
	\vspace{0.5ex}%
	%\par%
}
