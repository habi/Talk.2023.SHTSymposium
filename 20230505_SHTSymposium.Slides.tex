...
\renewcommand{\imwidth}{0.618\linewidth}
\begin{frame}
	\frametitle{\uct im Vergleich mit EM}
	\begin{columns}
		\begin{column}{0.49\linewidth}
			\centering
			\includegraphics[width=\imwidth]{./images/gold-nanoparticles-srxtm}
		\end{column}
		\begin{column}{0.49\linewidth}
			\centering
			\includegraphics[width=\imwidth]{./images/gold-nanoparticles-em}			
		\end{column}
	\end{columns}
	\centering
