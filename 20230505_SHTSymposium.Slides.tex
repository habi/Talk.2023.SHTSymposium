...
\begin{frame}
		...
		\begin{columns}%
			...
			\begin{column}{0.49\linewidth}%
				...
				\begin{tikzpicture}[x=\imagescale,y=-\imagescale,spy using outlines={rectangle,magnification=\mag,size=\size,connect spies}]
					...
					\only<2|handout:0>{\spy [ultra thick,white] on (2296,759) in node at (0,572.5) [anchor=west];}
	...
	\only<4|handout:0>{%
		\centering%
		\animategraphics[autoplay,width=\imagewidth,every=\everyframe]{24}{./images/R108/2010a/mrg/R108C04At-mrg/animation_frames/frame0}{201}{420}%
	}%
	\only<5|handout:0>{%
		\centering%
