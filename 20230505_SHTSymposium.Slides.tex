...
\begin{frame}[label=current]
	...
	\only<2>{%
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center){%
				\mode<beamer>{%
					\animategraphics[loop,autoplay,width=\linewidth,every=\everyframe]{24}{./images/R108/2010a/mrg/R108C04At-mrg/animation_frames/frame0}{000}{200}%
				}%
				\mode<handout>{%
					\includegraphics[width=\linewidth]{./images/R108/2010a/mrg/R108C04At-mrg/animation_frames/frame0420}%
				}%
			};%
		\end{tikzpicture}%
	}%
	\only<3>{%
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center){%
				\animategraphics[loop,autoplay,width=\linewidth,every=\everyframe]{24}{./images/R108/2010a/mrg/R108C04At-mrg/animation_frames/frame0}{201}{420}%
			};%
		\end{tikzpicture}%
	}%
	\only<4>{%
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center){%
				\animategraphics[loop,autoplay,width=\linewidth,every=\everyframe]{24}{./images/R108/2010a/mrg/R108C04At-mrg/animation_frames/frame0}{421}{677}%
			};%
		\end{tikzpicture}%
	}%
	\only<4>{%
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center){%
				\animategraphics[loop,autoplay,width=\linewidth,every=\everyframe]{24}{./images/R108/2010a/mrg/R108C04At-mrg/animation_frames/frame0}{678}{900}%
			};%
		\end{tikzpicture}%
	}%
\end{frame}

\renewcommand{\imagewidth}{0.4\linewidth}%
\begin{frame}%
	\frametitle{\uct in der digitalen Pathologie}%
	\begin{columns}%
		\begin{column}{0.49\linewidth}%
			\includegraphics[height=\imageheight]{./images/Amjad_B08_10543_III_F_HE_7.9x.png}%
...
\begin{frame}
	...
	\begin{itemize}
		\item<1-> \uct macht effiziente und zerstörungsfreie Bildgebung
		\item<1-> Färbung ist \emph{nicht} möglich, je nachdem aber auch nicht nötig
