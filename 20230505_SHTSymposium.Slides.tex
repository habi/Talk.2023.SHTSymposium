	...
	\begin{columns}
		\begin{column}{0.33\linewidth}
			...
			\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
				...
				\only<2->{%
					\draw[ubRedComplementary1,thick] (970,0) -- (970,1944);
				}
				\only<3->{%
					\draw[ubRedComplementary2,thick] (0,970) -- (1944,970);
				}
		...
		\begin{column}{0.33\linewidth}
			\only<2->{%
				...
				\begin{tikzpicture}[framed,background rectangle/.style={double,ultra thick,draw=red, top color=blue, rounded corners},x=\imagescale,y=-\imagescale]								
