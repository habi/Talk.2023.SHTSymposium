					...
					\node at (current page.center){%
						\mode<beamer>{%
							\begin{animateinline}[autoplay,every=\everyframe]{24}%
      								\multiframe{236}{i=0+1}{\includegraphics[width=\imagewidth]{./movies/mouse_skull/mouse_skull\zeropad{000}{\i}}}%
	      							\newframe*
    								\includegraphics[width=\imagewidth]{./movies/mouse_skull/mouse_skull236}% last frame needs to be repeated
		    					\end{animateinline}				
